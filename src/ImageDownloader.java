...
public class ImageDownloader {
    public static void getAndWrite(String urlString, File path) throws IOException {
        ...
        String toWriteTo = path.toPath().getParent().toString() + System.getProperty("file.separator");
        ...
        // Print the path of the image file that has been written. Image file name is generated from the HTTP path.
